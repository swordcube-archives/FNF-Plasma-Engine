...
class BitmapData implements IBitmapDrawable
{
	...
	**/
	public function new(width:Int, height:Int, transparent:Bool = true, fillColor:UInt = 0xFFFFFFFF)
	{
        ...
        // var cacheName = '${Date.now().getTime();}';
        // var e = 0;
        // if (Assets.cache.hasBitmapData(cacheName)) {
        //     while(Assets.cache.hasBitmapData('${cacheName}.$e')) {
        //         e++;
        //     }
        //     cacheName = '$cacheName.$e';
        // }
        // Assets.cache.setBitmapData(cacheName, this);
	}
